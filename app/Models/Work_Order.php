...
class Work_Order extends Model
{
    ...
    {
      return $this->belongsToMany('App\Models\Service', 'work_order_service', 'work_order_id', 'service_id')->withPivot('labor_hours', 'sale_price', 'line_cost', 'id', 'quantity');
    }

    public function products()
    {
      return $this->belongsToMany('App\Models\Product', 'work_order_product', 'work_order_id', 'product_id')->withPivot('tax', 'sale_price', 'line_cost', 'quantity');
    }

    public function invoice()
    {
      return $this->hasMany('App\Models\Invoice', 'work_order_id');
    }
    ...
    {
      return $this->hasMany('App\Models\Custom_Part', 'work_order_id', 'id');
    }

    public function custom_services()
    {
      return $this->hasMany('App\Models\Custom_Service', 'work_order_id', 'id');
    }
