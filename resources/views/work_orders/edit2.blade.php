    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="form-group">
          {!! Form::label('reason', 'Reason', ['class' => 'col-xs-12 col-sm-2 pl-0']) !!}
          <div class="col-xs-10">
        ...
        <div class="form-group">
          {!! Form::label('discount', 'Discount', ['class' => 'col-xs-12 col-sm-2 pl-0']) !!}
          <div class="col-xs-10">
        ...
        <div class="form-group">
          {!! Form::label('appointment_date', 'Appointment Date', ['class' => 'col-xs-12 col-sm-2 pl-0']) !!}
        ...
        <div class="form-group">
          {!! Form::label('delivery_date', 'Delivery Date', ['class' => 'col-xs-12 col-sm-2 pl-0']) !!}
          <div class="col-xs-3">
        ...
        <div class="form-group">
          {!! Form::label('truck_id', 'Truck', ['class' => 'col-xs-12 col-sm-2 pl-0']) !!}
          <div class="col-xs-10">
        ...
        <div class="card p-4">
          <div class="col-xs-12 col-md-4 bg-success text-white">
            <h4>Labor: $</h4>
            <h4 id="totalLaborCost">0.00</h4>
          </div>
          <div class="col-xs-12 col-md-4 bg-success text-white">
            <h4>Parts: $</h4>
            <h4 id="totalPartsCost">0.00</h4>
          </div>
          <div class="col-xs-12 col-md-4 bg-success text-white">
            <h4>Total: $</h4>
        ...
        <div class="card p-4">
        <div class="form-group">
          {!! Form::label('assigned_to', 'Assigned To', ['class' => 'col-xs-12 col-sm-2 pl-0']) !!}
          <div class="col-xs-5">
        ...
        <div class="form-group">
          {!! Form::label('status', 'Status', ['class' => 'col-xs-12 col-sm-2 pl-0']) !!}
          <div class="col-xs-5 pb-2">
        ...
        <div class="form-group">
          {!! Form::label('shop_work_status', 'Shop Work Status', ['class' => 'col-xs-12 col-sm-2 pl-0']) !!}
          <div class="col-xs-5">
        ...
        <div class="form-group">
          {!! Form::label('comments', 'Comment', ['class' => 'col-xs-12 col-sm-2 pl-0']) !!}
          <div class="col-xs-11">
        ...
        <div class="form-group">
          {!! Form::label('preferred_contact_method', 'Preferred Contact Method', ['class' => 'col-xs-12 col-sm-12 pl-0']) !!}
          <div class="col-xs-12 col-sm-6">
        ...
        <div class="form-group">
          <div class="row">
            ...
            ?>
            {!! Form::checkbox('wants_follow_up_calls', 1, $x) !!} Promotions<br />
          </div>
        ...
        <div class="col-xs-12 col-md-4">
            ...
            ?>
            {!! Form::checkbox('do_not_contact', 1, $x) !!} Do Not Contact<br />
          </div>
        </div>
        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <h4 class="modal-title">Add Part</h4>
        <button type="button" class="close p-3" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
