  ...
  <div class="table-responsive">
    <table class="table table-striped table-condensed">
      ...
      <tbody>
        ...
        <tr class="clickable-row" data-href="{{ url('/work_order/'.$work_order->id.'/edit/') }}" @if ($work_order->shop_work) style="background-color:lightblue" @endif>
          <td>
          ...
          <td>
            ...
            <a href="{{ url('/work_order/invoice/'.$work_order->id) }}" class="btn btn-success btn-xs" target="new"><i class="fa fa-dollar"></i></a>
            @endif
          </td>
          <td>
