                    ...
                    <div class="card-body-list">
                        <ul class="list-style-3 mb-0">
                            <li class="p-3 list-item d-flex justify-content-start align-items-center">
                                <div class="avatar">
                                    <img class="avatar avatar-img avatar-60 rounded" src="{{ asset('/public/theme/images/products/1.jpg')}}" alt="1.jpg">
                                </div>
                            ...
                            <li class="p-3 list-item d-flex justify-content-start align-items-center">
                                <div class="avatar">
                                    <img class="avatar avatar-img avatar-60 rounded" src="{{ asset('/public/theme/images/products/2.jpg')}}" alt="2.jpg">
                                </div>
                                <div class="list-style-detail ml-3 mr-2">
                            ...
                            <li class="p-3 list-item d-flex justify-content-start align-items-center">
                                <div class="avatar">
                                    <img class="avatar avatar-img avatar-60 rounded" src="{{ asset('/public/theme/images/products/13.jpg')}}" alt="3.jpg">
                                </div>
                                <div class="list-style-detail ml-3 mr-2">
                            ...
                            <li class="p-3 list-item d-flex justify-content-start align-items-center">
                                <div class="avatar">
                                    <img class="avatar avatar-img avatar-60 rounded" src="{{ asset('/public/theme/images/products/4.jpg')}}" alt="4.jpg">
                                </div>
                                <div class="list-style-detail ml-3 mr-2">
